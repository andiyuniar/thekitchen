...
namespace Kitchen.Api
{
    public class Startup
    {
        ...
        {
            services.Configure<KitchenDbSetting>(Configuration.GetSection(nameof(KitchenDbSetting)));
            services.AddSingleton<IKitchenDbSetting>(sp => sp.GetRequiredService<IOptions<KitchenDbSetting>>().Value);
